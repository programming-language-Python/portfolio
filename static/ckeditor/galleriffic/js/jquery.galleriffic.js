...
;(function ($) {
    ...
    $.fn.galleriffic = function (settings) {
            ...
            refresh: function () {
                ...
                if (this.$navControlsContainer) {
                    this.$navControlsContainer
                        .find('div.sidenav-controls a.prev').attr('href', '#' + this.data[this.getPrevIndex(index)].hash).end()
                        .find('div.sidenav-controls a.next').attr('href', '#' + this.data[this.getNextIndex(index)].hash);
                }
        ...
        if (this.navControlsContainerSel) {
            ...
            this.$navControlsContainer
                .append('<div class="sidenav-controls"><a class="prev" rel="history" title="' + this.prevLinkText + '">' + this.prevLinkText + '</a><a class="next" rel="history" title="' + this.nextLinkText + '">' + this.nextLinkText + '</a></div>')
                .find('div.sidenav-controls a')
                .click(function (e) {
                    gallery.clickHandler(e, this);
                });
        }
